 ...
 */
package com.liferay.faces.adf.security;
...
&lt;adf-config xmlns="http://xmlns.oracle.com/adf/config"
     ...
     &lt;sec:AdfSecurityConfigType&gt;
         &lt;sec:JaasSecurityContextType&gt;
             &lt;sec:contextEnv name="oracle.adf.security.identity.provider" value="com.liferay.faces.adf.security.LiferayADFIdentityProvider" /&gt;
         &lt;/sec:JaasSecurityContextType&gt;
     &lt;/sec:AdfSecurityConfigType&gt;
 &lt;/adf-config&gt;
 </pre>
 ...
 * @author  Neil Griffin
 */
public class LiferayADFIdentityProvider implements IdentityManagement {
