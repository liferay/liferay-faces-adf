 ...
 * @author  Neil Griffin
 */
public class BridgePortletRequestFactoryADFImpl extends BridgePortletRequestFactory {

	private BridgePortletRequestFactory wrappedBridgePortletRequestFactory;

	public BridgePortletRequestFactoryADFImpl(BridgePortletRequestFactory bridgePortletRequestFactory) {
	...
	public ResourceRequest getResourceRequest(ResourceRequest resourceRequest, ResourceResponse resourceResponse,
		PortletConfig portletConfig, BridgeConfig bridgeConfig) {
		return new ResourceRequestLiferayADFImpl(wrappedBridgePortletRequestFactory.getResourceRequest(resourceRequest,
