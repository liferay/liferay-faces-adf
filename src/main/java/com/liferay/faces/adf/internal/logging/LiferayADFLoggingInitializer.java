 ...
 */
package com.liferay.faces.adf.internal.logging;
 ...
 * @author  Neil Griffin
 */
public class LiferayADFLoggingInitializer implements ServletContainerInitializer {
	...
	public void onStartup(Set<Class<?>> classSet, ServletContext servletContext) throws ServletException {
		...
		if (resource != null) {
			...
			try {
				...
				saxParser.parse(inputStream, new LiferayADFLoggingHandler(logger));
			}
			catch (Exception e) {
